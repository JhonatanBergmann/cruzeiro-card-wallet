        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Lottie
              ...
              loop
            />
            <Text style={[styles.text, { fontSize: 15 }]}>Mantenha seus cartões organizados, matenha suas contas em dia.</Text>
            <Text style={[styles.text, { fontSize: 20 }]}>"ESTOU DE OLHO!"</Text>
          </View>
        </View>
      </Modal>
    </View >
